...
#pragma warning restore 0649
        ...
        #region Properties
        public static string _currentFile { get; private set; }
        public static string _sharedPath { get; private set; }
        ...
        public void OnItemSelected(FileBrowserItem item, bool isDoubleClick)
        {
            ...
            _currentFile = item.Name.ToLowerInvariant();
        }
